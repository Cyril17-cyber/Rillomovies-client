...
export default function Favourites({userDetails,  setSearchMenu, movies, setPopUp, setUserDetails, setPopMessage}) {
    useEffect(() => {
        redirect();
    }, []);
    ...
    const filteredMovies = movies.filter(filteredObject=> {
        return userDetails.favourites.includes(filteredObject._id);
    });
        ...
        <CircularProgress color="inherit" />
            ...
            <section className="favourites">
                 ...
                 {filteredMovies.length === 0 ? <div className="empty">
                        <h2 style={{textAlign: 'center'}}>You have no favourite movies</h2>
                    </div> : 
                    <>
